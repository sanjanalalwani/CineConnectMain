...
<head>
    ...
    <title> <?php echo $profileData->name; ?> (@<?php echo $profileData->username; ?>) | CineConnect</title>
        ...
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
              <!-- <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROXCUTfFX6ak-S0Wsnux2u-VWe_I2Bf77WLUNP_FKg_g&s" alt="" height="30px" width="30px" /> -->
            </div>
          </div>
