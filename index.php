...
<main class="twt-main">
            <section class="twt-login">
                <?php include 'includes/login.php';  ?>
                    <div class="slow-login">
                        <!-- <img class="login-bird" src="assets/images/logo.jpeg" alt="bird"> -->
    ...
    <br>
                        ...
                        <span class="join">Join CineConnect today.</span>
                        <button type="button" id="auto" onclick="" class="signup-btn pri-btn custom-btn" data-toggle="modal" data-target="#exampleModalCenter">
    Sign Up
</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
         ...
         <?php  include 'includes/signup-form.php' ?>
            ...
            <section class="twt-features" style="background-image: url('assets/images/cineconnect.png'); background-size: cover; background-position: center;">
    <!-- <div class="features-div">
        <img class="twt-icon" src='https://image.ibb.co/bzvrkp/search_icon.png'>
        <p>Follow your interests.</p>
        <img class="twt-icon" src="https://image.ibb.co/mZPTWU/heart_icon.png">
